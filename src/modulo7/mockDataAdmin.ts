...
export const PLANTILLAS_INICIALES: PlantillaDocumental[] = [
  {
    ...
    version: "UTA-SGC-A-2-1-P7-T1",
    estado: "ACTIVA",
    ultimaActualizacion: "07/09/2026",
    secciones: [
      "1. JUSTIFICACIÓN (Requerida)",
      "2. OBJETIVO (Requerido)",
      "3. MATRIZ DE ACTIVIDADES (Requerida: Tabla 1.- Matriz de actividades)",
      "4. ANEXOS (Opcional / No aplica)",
    ...
    configuracion: [
      ...
      { id: "general", titulo: "Información general", estado: "REQUERIDA", activa: true, bloqueada: false, detalle: "Unidad, carrera cuando aplica, grupo y período." },
      ...
      { id: "signatures", titulo: "Firmas de responsabilidad", estado: "REQUERIDA", activa: true, bloqueada: false, detalle: "Sección requerida y reordenable." },
      { id: "history", titulo: "Control de historial de cambios", estado: "REQUERIDA", activa: true, bloqueada: false, detalle: "Sección requerida y reordenable." },
  ...
  },
  {
    ...
    version: "UTA-SGC-A-2-1-P7-T2",
    estado: "ACTIVA",
    ultimaActualizacion: "07/09/2026",
    secciones: [
      "1. ANTECEDENTES (Requerida)",
      "2. DESARROLLO DE ACTIVIDADES (Requerida: Tabla 1.- Resultados de la matriz de actividades si deriva de plan o desarrollo textual)",
      "3. CONCLUSIONES (Requerida)",
      "4. OPORTUNIDADES DE MEJORA (Requerida)",
      "5. REGISTRO DE CONTACTOS Y GESTIONES DE LA DELEGACIÓN (Condicional / No aplica)",
    ...
    configuracion: [
      ...
      { id: "general", titulo: "Información general", estado: "REQUERIDA", activa: true, bloqueada: false, detalle: "Unidad, título y período." },
