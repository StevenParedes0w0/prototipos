...
export const PLANTILLAS_INICIALES: PlantillaDocumental[] = [
  ...
  {
    id: "plt-2",
    nombre: "Informe institucional / de actividades",
    tipoDocumento: "Informe",
    version: "1.0 — PRELIMINAR",
    estado: "ESTRUCTURA PENDIENTE DE DEFINICIÓN INSTITUCIONAL" as any,
    ultimaActualizacion: "07/09/2026",
    secciones: [
      "1. Información general y documento relacionado",
      "2. Introducción / Descripción",
      "3. Desarrollo de actividades / gestión",
      "4. Resultados registrados",
      "5. Observaciones (DEMO)",
      "6. Anexos institucionales",
